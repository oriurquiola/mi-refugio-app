...
import { C } from '../theme';
import { AppScreen, Technique } from '../types';
import { symptoms, techniques } from '../data';
import { GlassCard } from '../components/GlassCard';
import { openPsychologistChat } from '../config';

// Halo coral que respira para el CTA "Hablar con un psicólogo".
    ...
    <div className="min-h-screen pt-[32px] px-[20px] pb-[100px] flex flex-col gap-[24px]">
      ...
      <div className="flex flex-col gap-[12px] mt-[16px]">
        <button 
          ...
          style={{ backgroundColor: C.glass, border: `1px solid rgba(184,160,238,0.25)`, color: C.lavender }}
        >
          Guardar esta sesión
        </button>
        <motion.button
